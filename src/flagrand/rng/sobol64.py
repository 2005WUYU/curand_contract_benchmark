...
class Sobol64Generator:
    ...
    def generate_long_long(
        ...
        **kwargs: object,
        ...
        prepare_quasi_output(
            ...
            offset=offset_val,
            op_name="Sobol64.generate_long_long",
        )
        if out.numel() == 0:
            return out
        launch_sobol64_table(
            out,
            _SOBOL64_DIRECTION_VECTORS[:dimensions],
            dimensions=dimensions,
            offset=offset_val,
    ...
    def generate_uniform(self, out: torch.Tensor, **kwargs: object) -> torch.Tensor:
        ...
        prepare_quasi_output(
            ...
            max_dimensions=_SOBOL64_MAX_DIMENSIONS,
            offset=offset_val,
            op_name="Sobol64.generate_uniform",
        )
        if out.numel() == 0:
            return out
        launch_sobol64_uniform_table(
    ...
    def _generate_normal_like(
        ...
        **kwargs: object,
        ...
        dimensions = int(self.dimensions)
        op_name = "Sobol64.generate_lognormal" if lognormal else "Sobol64.generate_normal"
        prepare_quasi_output(
            out,
            dtype=torch.float64,
            dimensions=dimensions,
