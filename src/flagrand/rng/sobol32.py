...
class Sobol32Generator:
    ...
    def generate(
        ...
        **kwargs: object,
        ...
        prepare_quasi_output(
            ...
            offset=offset_val,
            op_name="Sobol32.generate",
        )
        if out.numel() == 0:
            return out
        launch_sobol32_table(
            out,
            _SOBOL32_DIRECTION_VECTORS[:dimensions],
            dimensions=dimensions,
            offset=offset_val,
    ...
    def generate_uniform(self, out: torch.Tensor, **kwargs: object) -> torch.Tensor:
        ...
        prepare_quasi_output(
            ...
            max_dimensions=_SOBOL32_MAX_DIMENSIONS,
            offset=offset_val,
            op_name="Sobol32.generate_uniform",
        )
        if out.numel() == 0:
            return out
        launch_sobol32_uniform_table(
    ...
    def _generate_normal_like(
        ...
        **kwargs: object,
        ...
        dimensions = int(self.dimensions)
        op_name = "Sobol32.generate_lognormal" if lognormal else "Sobol32.generate_normal"
        prepare_quasi_output(
            out,
            dtype=torch.float32,
            dimensions=dimensions,
